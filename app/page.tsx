...
const PRODUCTS = [
  {
    ...
    price: 6000,
    category: "perruques",
    img: "https://images.unsplash.com/photo-1520975682231-ae9a89dc85c5?q=80&w=1200&auto=format&fit=crop",
    stock: 12,
    isNew: true,
    isBest: true,
    rating: 4.7,
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1603575449219-3378a1a2a2ef?q=80&w=1200&auto=format&fit=crop",
    stock: 30,
    isNew: true,
    isBest: false,
    rating: 4.5,
  ...
  },
  {
    ...
    price: 4900,
    category: "figurines",
    img: "https://images.unsplash.com/photo-1608889175123-8c701f29f1d6?q=80&w=1200&auto=format&fit=crop",
    stock: 0,
    isNew: false,
    isBest: false,
    rating: 4.2,
  ...
  {
    id: "goo-1",
    name: "Goodies Stickers AfroGeek (pack 20)",
    price: 9000,
    category: "goodies",
